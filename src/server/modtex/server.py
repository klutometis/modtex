...
class ModtexForkingMixIn(ForkingMixIn):
    max_children = Config.max_children

class ModtexRequestHandler(SimpleXMLRPCRequestHandler):
    def setrlimits(self):
    ...
    def setup(self):
        ...
        # Only set rlimits on non-debug
        if not __debug__:
            self.setrlimits()

class ModtexServer(ModtexForkingMixIn, SimpleXMLRPCServer):
    ...
    def __init__(self, actions):
        ...
        self.register_instance(ModtexActions(actions))
        self.serve_forever()
        # self.handle_request()
